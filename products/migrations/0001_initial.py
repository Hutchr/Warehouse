    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(allow_unicode=True, blank=True, null=True)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='products.CategorySite')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('a', 'Ενεργό'), ('b', 'Μη Ενεργό')], default='a', max_length=1, verbose_name='Κατάσταση')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cellphone', models.CharField(blank=True, max_length=10, null=True, verbose_name='CellPhone')),
                ...
                ('category', models.CharField(blank=True, choices=[('a', 'Retail'), ('b', 'Eshop'), ('c', 'PhoneRetail'), ('d', 'Stock')], default='a', max_length=1, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('measure_unit', models.CharField(default='Τεμ.', max_length=10)),
                ...
                ('category_site', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='products.CategorySite')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', smartfields.fields.ImageField(upload_to=products.models.product_directory_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remaining_deposit', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Υπόλοιπο προκαταβολών')),
            ],
            options={
